<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="EFCAO.Default" %>
...
<head runat="server">
    ...
    <script lang="javascript" type="text/javascript">
        function CountCaddie(numberOfItems) {
            parent.CountCaddie(numberOfItems);
        }
    </script>
...
<body>
    <form id="form1" runat="server">
            ...
            <div class="navbar-form navbar-left">
                <div class="form-group">                                                    
                   <asp:Label ID="LblSearchComp" runat="server" Text="Recherche de sociétés :"></asp:Label>
                    <%--<input type="text" class="form-control" id="TBoxRecherche" autofocus="autofocus" runat="server" />
                   <asp:LinkButton ID="LkBttnSearchComp" runat="server" CssClass="btn btn-social-icon btn-default btn-md" OnClick="LkBttnSearchComp_Click" ToolTip="Recherche" OnClientClick="ViewLoading();"> <span aria-hidden="true" class="fa fa-search"></span></asp:LinkButton>--%>   
        ...
        <div class="row">
                    ...
                    <div class="box-body">  
                        ...
                        <asp:GridView ID="SearchCompanyGridView" runat="server" AutoGenerateColumns="False" PageSize="10" onrowcommand="SearchCompanyGridView_RowCommand" 
                            onpageindexchanging="SearchCompanyGridView_PageIndexChanging" AllowPaging="True" DataKeyNames="Key" onrowdatabound="SearchCompanyGridView_RowDataBound" CssClass="table table-bordered table-hover">
		                        ...
		                        <asp:BoundField HeaderText="Modèle" DataField="ModeleLabel" ReadOnly="true"  ItemStyle-Width="15%"/>
          ...
          <asp:Panel ID="PanelGridViewExceriesMain" runat="server" visible="false">
            ...
            <div class="col-md-12">
                    ...
                    <div class="box-body">  
                            ...
                            <asp:GridView ID="GridViewExerciesMain" runat="server" AutoGenerateColumns="false" PageSize="3" AllowPaging="true" 
                            CssClass="table table-bordered table-hover" onpageindexchanging="GridViewExerciesMain_PageIndexChanging" OnRowDataBound="GridViewExerciesMain_RowDataBound">
                            <rowstyle backcolor="#c5edfc" />
                                <alternatingrowstyle backcolor="white"  />
                                <Columns>
                                    <asp:BoundField HeaderText="Type" DataField="TypeExercice" ReadOnly="true"  Visible="false"/>
                                    <asp:BoundField HeaderText="Verrou" DataField="Verrouille" ReadOnly="true"  Visible="false"/>
                     
                                    <asp:TemplateField Visible="false">
                                        <ItemTemplate>
                                            <asp:CheckBox runat="server" ID="CheckDate1" Checked='<%#Eval("RowChecked") %>' Enabled="false"></asp:CheckBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>  

                                    <asp:TemplateField>
                                        <ItemTemplate>
                                            <asp:Label ID="TheDateExer" runat="server" Text='<%#Eval("DateExer") %>' DataFormatString="{0:dd-MM-yyyy}"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>                                                                                                      
                                    <asp:BoundField HeaderText="Unité" DataField="Unite" ReadOnly="true"  />
                                    <asp:BoundField HeaderText="Devise" DataField="Currency" ControlStyle-Width="40"/>
                                    <asp:BoundField HeaderText="Durée / Mois" DataField="DureeExer" ReadOnly="true"/>
		                            <asp:BoundField HeaderText="Modèle" DataField="Model" ReadOnly="true"/>
                                    <asp:TemplateField HeaderText="Key"  Visible="false">
                                    <ItemTemplate >
                                    <asp:Label ID="ExerciesKey1" runat="server" Text='<%#Eval("CleUnik") %>'></asp:Label>      
                                    </ItemTemplate>
                                    </asp:TemplateField>
                            </Columns>
          ...
          <div class="row" id="RowMesgOrder" runat="server" visible="false">
            <!-- left column -->
            <div class="col-sm-12" style="text-align:center">
                <asp:Label ID="LblConfirmOrder" runat="server" ForeColor="Green"></asp:Label>
            </div>
         </div>
          <div class="row">
            <!-- left column -->
            <div class="col-sm-12" style="text-align:right">
                <asp:Button ID="BttnModeAvance" runat="server" Text="Mode avancé" CssClass="btn btn-primary" OnClick="BttnModeAvance_Click"/>
                <asp:Button ID="BttnGetDocImedit" runat="server" Text="Obtenir les documents" CssClass="btn btn-primary" OnClick="BttnGetDocImedit_Click"/> 
                  ...
                  <ContentTemplate>          
                    <div class="modal-content">
                        ...
                        <div class="modal-footer"> 
                                <asp:Button ID="btnCommandOk" runat="server" Text="OK" CssClass="btn btn-primary" OnClick="btnCommandOk_Click" Visible="false" OnClientClick="ViewLoading();" />                                                                               
                                <button class="btn btn-danger" data-dismiss="modal" aria-hidden="true" id="BttnAvertisClose" runat="server">Close</button>
                        </div><!-- modal-footer -->
                    </div>
                  </ContentTemplate>
                    <Triggers>
                        <asp:PostBackTrigger ControlID="btnCommandOk"/>                                                                                       
                    </Triggers>
                </asp:UpdatePanel>    
        ...
        <div class="modal-dialog modal-lg">
            <asp:UpdatePanel ID="UpdatePanelExerciesModel" runat="server" ChildrenAsTriggers="true" UpdateMode="Conditional"  >
              <ContentTemplate>
                ...
                <div class="modal-header panel-heading">                      
                    ...
                    <div class="modal-title">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <asp:Label ID="LblAvanceExercicesCompName" runat="server" Text="Exercices modèles pour" CssClass="h3"></asp:Label>
                                 <br />
                                 <small><asp:Label ID="LblAvanceCompIdentifiant" runat="server" Text="Identifiant :"></asp:Label> <asp:Label ID="LblAvanceCompIdentifiantVal" runat="server"></asp:Label></small>
                                 <br />
                                 <small>
                                     <asp:Label ID="LblAvanceCompAddressVal" runat="server"></asp:Label>&nbsp; <asp:Label ID="LblAvanceCompZipVal" runat="server" ></asp:Label>&nbsp;
                                     <asp:Label ID="LblAvanceCompCityVal" runat="server" /> &nbsp;<asp:Label ID="LblAvanceCompRegionVal" runat="server" ></asp:Label>&nbsp;
                                     <asp:Label ID="LblAvanceCompCountryVal" runat="server" ></asp:Label>
                ...
                <div class="modal-body"> 
                    ...
                    <asp:Panel ID="PanelExerciesModel" runat="server">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-7">                                
                                <asp:DropDownList ID="DDListExerciesModels" runat="server" AutoPostBack="True" CssClass="form-control" onselectedindexchanged="DDListExerciesModels_SelectedIndexChanged">
                                </asp:DropDownList>
                            </div>
                            <div class="col-lg-4">
                                <asp:Button ID="BttnGetProdDoc" runat="server" CssClass="btn btn-primary" OnClick="BttnGetDocAvance_Click" Text="Obtenir les documents" OnClientClick="ViewLoading();"/>
                            </div>
                        </div>
                    </asp:Panel>
                    <br />
                    ...
                    <asp:Panel ID="PanelExerciesGridView" runat="server" Visible="false">
                        <asp:GridView ID="ExerciesGridViewAvance" runat="server" AutoGenerateColumns="false" Visible="true" PageSize="15" AllowPaging="true" 
                                 onpageindexchanging="ExerciesGridViewAvance_PageIndexChanging" onrowcommand="ExerciesGridViewAvance_RowCommand" CssClass="table table-bordered table-hover" OnRowDataBound="ExerciesGridViewAvance_RowDataBound">
                                 <rowstyle backcolor="#c5edfc" />
                                     <alternatingrowstyle backcolor="white"  />
                                     <Columns>
                                   ...
                                   <asp:GridView ID="GridViewDocumentSaisie" runat="server" AllowPaging="true" AutoGenerateColumns="false" OnPageIndexChanging="GridViewDocumentSaisie_PageIndexChanging" PageSize="6" CssClass="table table-bordered table-hover" OnRowDataBound="GridViewDocumentSaisie_RowDataBound">
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="Sélectionnez" ItemStyle-Width="10%">
                                            <ItemTemplate>
                                                <asp:CheckBox ID="CheckBoxSaisie" runat="server" OnCheckedChanged="CheckBoxSaisie_CheckedChanged" Checked='<%#Eval("Doc_Checked")%>' AutoPostBack="true" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                      ...
                      <div class="col-lg-12">
                           ...
                           <asp:GridView ID="GridViewDocumentAnalyse" runat="server" AllowPaging="true" AutoGenerateColumns="false" CssClass="table table-bordered table-hover" OnPageIndexChanging="GridViewDocumentAnalyse_PageIndexChanging" PageSize="6" OnRowDataBound="GridViewDocumentAnalyse_RowDataBound">
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="Sélectionnez" ItemStyle-Width="10%">
                                        <ItemTemplate>
                                            <asp:CheckBox ID="CheckBoxAnalyse" runat="server" OnCheckedChanged="CheckBoxAnalyse_CheckedChanged" Checked='<%#Eval("Doc_Checked")%>' AutoPostBack="true" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                     <asp:BoundField ControlStyle-CssClass="texte" DataField="Ades_Doc_ID" HeaderText="ID" ReadOnly="true" />
                                    <asp:BoundField ControlStyle-CssClass="texte" DataField="Doc_Name" HeaderText="Label" ReadOnly="true" />
                ...
                <!-- modal-footer -->
                <div class="modal-footer">
                    <asp:Button ID="BttnSelectAll" runat="server" Text="Tout sélectionner" onclick="BttnSelectAll_Click" CssClass="btn btn-primary" />                          
                    <asp:Button ID="BttnUnSelectAll" runat="server" Text="Tout desélectionner" onclick="BttnUnSelectAll_Click" CssClass="btn btn-primary" />
                    <asp:Button ID="BttnOk" runat="server" Text="Ok" onclick="BttnOk_Click" CssClass="btn btn-primary" Visible="False"/>
                    <asp:Button ID="BttnDownLoad" runat="server" Text="Télécharger" CssClass="btn btn-primary" Enabled="False" OnClick="BttnDownLoad_Click" Visible="False"/>
